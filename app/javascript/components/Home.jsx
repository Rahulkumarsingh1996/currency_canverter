...
//                         id="base-currency"
//                         value={baseCurrency}
//                         onChange={(e) => setBaseCurrency(e.target.value)} className="base_curr"
//                         >
...
//                         <button onClick={convertCurrency} className="convert">Convert</button>
//                     </div>
                      
//                      <div className="mt-5" id="result">
//                         {result && (
//                             <div>
//                             <h5>The current currency of <i class="fa-duotone fa-dollar-sign"></i></h5>
//                             <p>
...
//                             <i class="fa-solid fa-download mt-2"></i> <Download/>
//                             </div>
...
//         <p className="bio">A currency converter is a tool that converts one currency's value or quantity into 
//            the relative values or amounts of other currencies. Currency conversion is carried out by
//             utilising specialised software programmes that are created to be rapid and precise. Currency 
//             converters,which are widely and freely available online, can quickly convert the value of 
//             one currency into another.You can, for example, quickly convert dollars to rupees or rupees to 
//            pounds, and vice versa.
//         </p>
//         <p className="bio">They're especially helpful for travellers who want to know how much their home currency will rise 
//             or fall when visiting a new foreign country.</p>

//         <p className="bio">A universal currency converter is so named because it allows you to convert any foreign currency into any domestic currency</p>
